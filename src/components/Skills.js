...
const Skills = () => {
  ...
  return (
    <div
      name="skills"
      className="bg-gradient-to-b from-gray-800 to-black w-full] sm:pt-[60px] pt-[30px] sm:pb-[60px] pb-[30px]"
    >
      <div className="mx-auto flex flex-col justify-center w-full text-white max-w-[1100px] px-8">
        ...
        <div className="w-full grid sm:grid-cols-2 md:grid-cols-4 gap-8 text-center pb-8">
