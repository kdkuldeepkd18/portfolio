...
const FinePrint = () => {
  return (
    <div name="fineprint" className="w-full bg-[#000000] text-[#ffffff] ">
      <div className="flex flex-col justify-center items-center w-full pb-[2.5rem] pt-[2.5rem] sm:pt-[6rem] sm:pb-[6rem]">
        <div className="max-w-[1100px] w-full grid sm:grid-cols-2 gap-8 px-4">
          <div className="sm:text-left  ">
            ...
            <p className="text-[14px] sm:text-[16px] sm:mb-4">
          ...
          <div className=" ">
            ...
            <div className=" flex sm:flex-row-reverse ">
              <ul className=" flex">
                <li className="w-[55px] h-[55px] pl-0 sm:pl-4  transform transition duration-500 hover:scale-150">
                  <a
      ...
      <div className="flex justify-center items-center w-full ">
        <div className="max-w-[1100px] items-center w-full px-4 border-t-[1px] border-[#444444] pb-[1rem] pt-[1rem] sm:pt-[3rem] sm:pb-[3rem]">
