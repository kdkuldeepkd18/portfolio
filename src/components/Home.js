  ...
  return (
    <div name="home" className="w-full items-center banner-div ">
      ...
      <div className="max-w-[1100px]  mx-auto px-8 flex flex-col justify-center pt-[150px] pb-[80px] sm:pt-[200px] sm:pb-[140px]  ">
        ...
        <div>
          <button className="text-white group border-2 px-6 py-3 my-2 flex items-start hover:bg-[#e45447] hover:border-[#e45447] hover:scale-110 duration-300 rounded-md ">
            View Work
