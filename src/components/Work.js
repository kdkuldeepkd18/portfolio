...
const Work = () => {
  return (
    <div
      name="work"
      className="work-div w-full bg-[#fff] sm:pt-[60px] pt-[30px] sm:pb-[60px] pb-[30px]"
    >
      <div className="max-w-[1100px] mx-auto px-8 flex flex-col justify-center text-black">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8">
          ...
          <div
            ...
            className="shadow-lg shadow-[#000000] group container rounded-md flex justify-center items-center mx-auto content-div hover:scale-105 duration-500"
          >
            {/* Hover Effects */}
